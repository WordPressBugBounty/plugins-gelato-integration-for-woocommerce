...
<?php if (
        (isset($status_results['test_gelato_webhooks'])
         && $status_results['test_gelato_webhooks']['status'] == GelatoStatusChecker::STATUS_FAIL)
    || (isset($status_results['test_wc_api_access_by_gelato'])
