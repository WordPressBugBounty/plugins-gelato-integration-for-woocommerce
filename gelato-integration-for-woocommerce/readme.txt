...
Plugin URI: https://gelato.com/
Tags: woocommerce, gelato, drop shipping, shipping, live shipping rates, fulfillment, printing, print on demand, custom printing, t-shirt
Author: Gelato
...
Check out our [YouTube channel](https://www.youtube.com/channel/UCq8oDo3EFcx6qHu1v5YITqQ) and [blog](https://gelato.com/en-US/blog/) for more tips and inspiration for how to connect and grow your ecommerce store with Gelato.
...
= 1.0.1 =
* Improvements for Live shipping rates
* Fixed issue with PHP 7.0 version

= 1.0.2 =
* Improvements for Live shipping rates

= 1.0.5 =
* Improvements for status page

= 1.0.6 =
* Improvements for redirect check

= 1.1.0 =
* Added support for Multi-sites

= 1.1.1 =
* Fixed memory limit validation

= 1.2.0 =
* Fixed issue with duplicate variant ids

= 1.2.1 =
* Improvements for redirect check and status page
...
= 1.3.2 =
* Send appHandle on WooCommerce connect and health/shipping requests
* Centralize branding constants in GelatoConfig
